 ...
 * @param {string} receiver_nsec_hex
 * @param {string} sender_npub_hex
 * @param {string} ciphertext_b64
 * @returns {string}
 */
export function nip44_decrypt(receiver_nsec_hex, sender_npub_hex, ciphertext_b64) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(receiver_nsec_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(sender_npub_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @param {string} sender_nsec_hex
 * @param {string} recipient_npub_hex
 * @param {string} plaintext
 * @returns {string}
 */
export function nip44_encrypt(sender_nsec_hex, recipient_npub_hex, plaintext) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(sender_nsec_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(recipient_npub_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
export function pubkey_from_nsec(nsec_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(nsec_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pubkey_from_nsec(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {number}
 */
export function qr_actual_size(text, scale) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.qr_actual_size(ptr0, len0, scale);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
 ...
 * @param {string} text
 * @param {number} scale
 * @param {number} dark_rgb
 * @param {number} light_rgb
 * @returns {Uint8Array}
 */
export function qr_pixels(text, scale, dark_rgb, light_rgb) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.qr_pixels(ptr0, len0, scale, dark_rgb, light_rgb);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {string}
 */
export function sign_event(nsec_hex, kind, tags_json, content) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(nsec_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.sign_event(ptr0, len0, kind, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nostr_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
